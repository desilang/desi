...
[contributing/compiler/limits.md](https://github.com/desilang/desi/blob/main/docs/contributing/compiler/limits.md).

## For contributors

The implementation, invariants, and the gotchas that have caused real
bugs are documented in
[contributing/runtime/drops-implementation.md](https://github.com/desilang/desi/blob/main/docs/contributing/runtime/drops-implementation.md).
...
[roadmap/planned/hybrid_memory_management.md](https://github.com/desilang/desi/blob/main/docs/roadmap/planned/hybrid_memory_management.md).
