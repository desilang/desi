...
RUNTIME_OBJS = $(BUILD_DIR)/set.o $(BUILD_DIR)/dict.o $(BUILD_DIR)/print.o $(BUILD_DIR)/string.o $(BUILD_DIR)/list.o $(BUILD_DIR)/file.o $(BUILD_DIR)/arena.o $(BUILD_DIR)/builtins.o $(BUILD_DIR)/iterator.o $(BUILD_DIR)/scheduler.o $(BUILD_DIR)/mutex.o $(BUILD_DIR)/channel.o $(BUILD_DIR)/taskgroup.o
